        ...
        <div className="ag-courses_box">
          <div className="ag-courses_item">
            <a href="/categories/plumbers" className="ag-courses-item_link">
              ...
              <div className="ag-courses-item_date-box">
                <span className="ag-courses-item_date">Débouchage de canalisation</span><br />
                <span className="ag-courses-item_date">Installation de sanitaires</span><br />
          ...
          <div className="ag-courses_item">
            <a href="/categories/menage" className="ag-courses-item_link">
              ...
              <div className="ag-courses-item_date-box">
                <span className="ag-courses-item_date">Nettoyage de maisons</span><br />
                <span className="ag-courses-item_date">Nettoyage de bureaux</span><br />
          ...
          <div className="ag-courses_item">
            <a href="/categories/reparation" className="ag-courses-item_link">
              ...
              <div className="ag-courses-item_date-box">
                <span className="ag-courses-item_date">Réparation de lave-linge</span><br />
                <span className="ag-courses-item_date">Maintenance de réfrigérateurs</span><br />
          ...
          <div className="ag-courses_item">
            <a href="/categories/jardinage" className="ag-courses-item_link">
              ...
              <div className="ag-courses-item_date-box">
                <span className="ag-courses-item_date">Aménagement paysager</span><br />
                <span className="ag-courses-item_date">Entretien de jardins</span><br />
          ...
          <div className="ag-courses_item">
            <a href="/categories/tuto" className="ag-courses-item_link">
              ...
              <div className="ag-courses-item_date-box">
                <span className="ag-courses-item_date">Soutien scolaire</span><br />
                <span className="ag-courses-item_date">Cours de langues</span><br />
          ...
          <div className="ag-courses_item">
            <a href="/categories/demenagment" className="ag-courses-item_link">
              ...
              <div className="ag-courses-item_date-box">
                <span className="ag-courses-item_date">Aide au déménagement</span><br />
                <span className="ag-courses-item_date">Services de transport</span><br />
